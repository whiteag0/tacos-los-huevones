...
export default function MenuSection({ category, items }: MenuSectionProps) {
  ...
  return (
    <section id={category} className="py-12 scroll-mt-20">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-red-500 to-orange-500 flex items-center justify-center text-white shadow-lg shadow-red-500/25">
            {info.icon}
          </div>
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900">{info.title}</h2>
        </div>
        <p className="text-gray-500 ml-13">{info.description}</p>
      </div>
